...
- **Follows your actual payday, not the calendar** — most budget apps reset on the 1st of the month. This one doesn't assume that. You start a new cycle whenever you actually get paid, whether that's regular or not.
- **Lets you set your own cycle length** — defaults to 30 days, but you can change it in Settings to match how often you actually get paid (weekly, bi-weekly, monthly, or anything else).
...
### Logging money
Two buttons on the home screen: **+ Log income** and **+ Log expense**. There's also the round **+** button at the bottom-right of the screen, which logs an expense on a normal tap.
...
**Shortcut for the round + button:** you can also log income straight from it, without switching to the other button.
- **On your phone:** press and hold the **+** — a second, green **+** swipes up next to it. Drag your finger onto it and release, or let go and tap it separately.
- **On a computer:** hover your mouse over the **+** and the green one appears — click it to log income.

### Starting a new cycle when you get paid
When you log income, you'll see a checkbox: **"Start a new cycle from today."**

- Leave it **unchecked** if this is just a top-up (a gift, a refund, side income) — it simply adds to your current cycle's budget.
- **Check it** when this is your actual pay/allowance arriving — it closes out the current cycle and starts a fresh one from today (using whatever cycle length you've set in Settings), carrying over any money you haven't spent yet.
...
### Settings tab
Edit your savings goal, cash/online balances, cycle length, or manually correct your cycle's start date if needed. Changing the cycle length updates the current cycle right away and also becomes the default for future cycles, until you change it again. There's also an option to clear all entries for the current cycle if you want to start over (your goal and balances stay put).
